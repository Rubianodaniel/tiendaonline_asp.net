...
public partial class DbventaContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdCategoria).HasName("PK__Categori__8A3D240CA85FE907");
        ...
        {
            entity.HasKey(e => e.IdDetalleVenta).HasName("PK__DetalleV__BFE2843FB89C9095");
        ...
        {
            entity.HasKey(e => e.IdMenu).HasName("PK__Menu__C26AF48329E90C6E");
        ...
        {
            entity.HasKey(e => e.IdNegocio).HasName("PK__Negocio__70E1E107ED3BE7B4");
        ...
        {
            entity.HasKey(e => e.IdNumeroCorrelativo).HasName("PK__NumeroCo__25FB547E99AF569B");
        ...
        {
            entity.HasKey(e => e.IdProducto).HasName("PK__Producto__07F4A13239DC9FE5");
        ...
        {
            entity.HasKey(e => e.IdRol).HasName("PK__Rol__3C872F7669F8A21A");
        ...
        {
            entity.HasKey(e => e.IdRolMenu).HasName("PK__RolMenu__CD2045D8B3E6F949");
        ...
        {
            entity.HasKey(e => e.IdTipoDocumentoVenta).HasName("PK__TipoDocu__A9D59AEE54522BD7");
        ...
        {
            entity.HasKey(e => e.IdUsuario).HasName("PK__Usuario__645723A6FDBEBC03");
        ...
        {
            entity.HasKey(e => e.IdVenta).HasName("PK__Venta__077D5614CF492A07");
